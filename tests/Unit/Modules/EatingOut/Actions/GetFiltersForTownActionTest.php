...
class GetFiltersForTownActionTest extends TestCase
{
    ...
    {
        $categoryFilters = $this->callAction(GetFiltersForTownAction::class, $this->town, ['category' => 'att'])['categories'];
    ...
    public function aFilterVenueTypeCanBeCheckedViaTheRequest(): void
    {
        ...
        $categoryFilters = $this->callAction(GetFiltersForTownAction::class, $this->town, ['venueType' => $venueType->slug])['venueTypes'];
    ...
    public function aFilterFeatureCanBeCheckedViaTheRequest(): void
    {
        ...
        $featureFilters = $this->callAction(GetFiltersForTownAction::class, $this->town, ['feature' => $feature->slug])['features'];
