...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    'apex-chart': vue3_apexcharts__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  props: {
    card: {
      required: true,
  ...
  data: function data() {
    return {
      ...
      chart: undefined,
      startDate: dayjs__WEBPACK_IMPORTED_MODULE_1___default()().subtract(1, 'day').format('YYYY-MM-DD'),
      endDate: dayjs__WEBPACK_IMPORTED_MODULE_1___default()().format('YYYY-MM-DD')
    };
  },
  computed: {
    dateRangeOptions: function dateRangeOptions() {
      return [].concat(_toConsumableArray(this.dateRanges), _toConsumableArray(this.card.customDateRange ? [{
        label: 'Custom',
        value: 'custom'
      }] : []));
    }
  ...
  methods: {
    getChartable: function getChartable() {
      var _this = this;
      this.loading = true;
      Nova.request().get(this.buildUrl()).then(function (response) {
        _this.dateRanges = response.data.dates;
        _this.selectedDateRange = response.data.selectedDateRange;
        _this.chart = response.data.chart;
        _this.loading = false;
      })["catch"](function (error) {
        var _error$response;
        Nova.error(error === null || error === void 0 || (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.data);
      });
    },
    buildUrl: function buildUrl() {
      var url = '/nova-vendor/apex-charts';
    ...
    handleDateRangeChange: function handleDateRangeChange(value) {
...
var _hoisted_2 = {
  "class": "flex justify-between itesm-center"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_apex_chart = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("apex-chart");
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_Card, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", {
        "class": "text-3xl text-gray-500 font-light",
        textContent: (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.card.name)
      }, null, 8 /* PROPS */, _hoisted_3), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [!_ctx.loading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_SelectControl, {
        key: 0,
        options: $options.dateRangeOptions,
        selected: _ctx.selectedDateRange,
        onChange: $options.handleDateRangeChange
      }, null, 8 /* PROPS */, ["options", "selected", "onChange"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.selectedDateRange === 'custom' ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
        key: 1,
        ...
        onChange: _cache[1] || (_cache[1] = function () {
          return $options.getChartable && $options.getChartable.apply($options, arguments);
        })
      }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_5)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.startDate]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.selectedDateRange === 'custom' ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
        key: 2,
      ...
      }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_6)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.endDate]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_LoadingView, {
        loading: _ctx.loading
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_apex_chart, {
            width: "100%",
            type: _ctx.chart.type,
            options: _ctx.chart.options,
            series: _ctx.chart.data
          }, null, 8 /* PROPS */, ["type", "options", "series"])])];
        }),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["loading"])])];
    }),
...
Nova.booting(function (app, store) {
  app.component('apex-charts', _components_Card__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/* harmony import */ var _Users_jamiepeters_code_coeliac_next_nova_components_ApexCharts_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_jamiepeters_code_coeliac_next_nova_components_ApexCharts_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Card_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Card_vue_vue_type_template_id_b9bc2c0a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/Card.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjpeters8889_apex_charts"] = self["webpackChunkjpeters8889_apex_charts"] || [];
