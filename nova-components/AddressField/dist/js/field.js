...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    google.maps.event.addListener(this.map, 'bounds_changed', function () {
      var center = _this.map.getBounds().getCenter();
      _this.latitude = center.lat();
      _this.longitude = center.lng();
      _this.marker.setPosition(new google.maps.LatLng(_this.latitude, _this.longitude));
    });
  },
  methods: {
    /*
    ...
    lookup: function lookup() {
      ...
      Nova.request().post('/nova-vendor/jpeters8889/address-field/lookup', {
        address: this.address
      }).then(function (response) {
        console.log(response);
        _this2.address = response.data.formatted_address.replace(/, /g, '\n');
        _this2.latitude = response.data.lat;
        _this2.longitude = response.data.lng;
        var latLng = new google.maps.LatLng(_this2.latitude, _this2.longitude);
        _this2.marker.setPosition(latLng);
        _this2.map.setCenter(latLng);
        _this2.map.setZoom(16);
      })["finally"](function () {
        return _this2.isLookingUp = false;
      });
    },
    /**
...
var _hoisted_1 = {
  "class": "map-container flex flex-col space-y-2"
};
var _hoisted_2 = {
  "class": "address-container flex flex-col space-y-2"
};
var _hoisted_3 = ["id"];
var _hoisted_4 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("textarea", {
        id: "".concat($props.field.attribute, "-address"),
        "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
          return _ctx.address = $event;
        }),
        type: "text",
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["form-control form-input-bordered form-input h-auto w-full py-3", _ctx.errorClasses]),
        placeholder: "Address",
        rows: "5"
      }, null, 10 /* CLASS, PROPS */, _hoisted_3), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.address]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        id: "".concat($props.field.attribute, "-latitude"),
        ref: "latitude",
        "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
          return _ctx.latitude = $event;
        }),
        type: "text",
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["form-control form-input-bordered form-input w-full", _ctx.errorClasses]),
        placeholder: "Latitude",
        disabled: ""
      }, null, 10 /* CLASS, PROPS */, _hoisted_5), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.latitude]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        id: "".concat($props.field.attribute, "-longitude"),
        ref: "longitude",
        "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
          return _ctx.longitude = $event;
        }),
        type: "text",
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["form-control form-input-bordered form-input w-full", _ctx.errorClasses]),
        placeholder: "Longitude",
        disabled: ""
      }, null, 10 /* CLASS, PROPS */, _hoisted_6), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.longitude]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DefaultButton, {
        size: "sm",
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Lookup Address ")];
        }),
        _: 1 /* STABLE */
      })]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, " Map ", 512 /* NEED_PATCH */)])];
    }),
...
Nova.booting(function (app, store) {
  app.component('index-address-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-address-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-address-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var _Users_jamiepeters_code_coeliac_next_nova_components_AddressField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_jamiepeters_code_coeliac_next_nova_components_AddressField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _Users_jamiepeters_code_coeliac_next_nova_components_AddressField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjpeters8889_address_field"] = self["webpackChunkjpeters8889_address_field"] || [];
