...
class CreateEateryMapPageOpenGraphImageJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(RenderOpenGraphImage $renderOpenGraphImage): void
    {
        ...
        $base64Image = $renderOpenGraphImage->handle(view('og-images.eatery-map', [
        ...
        $openGraphModel = OpenGraphImage::query()->firstOrCreate(['route' => 'eatery-map']);
