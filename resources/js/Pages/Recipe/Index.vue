...
import {
  RecipeDetailCard as RecipeDetailCardType, RecipeFeature, RecipeFreeFrom, RecipeMeal,
...
const selectedMeals: Ref<string[]> = ref([]);
...
const selectedAllergens: Ref<string[]> = ref([]);
  ...
  <Card class="mt-3 flex flex-col space-y-4">
    ...
    <div class="grid md:grid-cols-3 gap-3">
      <RecipeListFilterCard
        ...
        @changed="(options) => {selectedFeatures = options}"
      />
      ...
      <RecipeListFilterCard
        ...
        @changed="(options) => {selectedMeals = options}"
      />
      ...
      <RecipeListFilterCard
        ...
        @changed="(options) => {selectedAllergens = options}"
      />
    </div>
