...
<template>
  <Card class="mt-3 flex flex-col space-y-4">
    ...
    <p class="prose max-w-none md:prose-lg xl:prose-xl">
      ...
      the world, so wherever you are visiting you can eat safely. We also do
      wristbands in various sizes, lanyards which are perfect for parties, water
      and freezer proof gluten free stickers and a few other bits and bobs!
    </p>
  </Card>
