...
const value = ref<FormMultiSelectOption[]>(props.modelValue);
...
watch(otherValue, () => {
  const existingOptions: FormMultiSelectOption[] = value.value;
          ...
          <ListboxOptions :class="optionWrapperClasses()">
            ...
            <template v-if="allowOther">
              ...
              >
                ...
                <div
                  :class="liTextClasses(otherOptionActive, otherOptionSelected)"
                >
